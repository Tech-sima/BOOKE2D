...
// Старые переменные для кругов удалены - используется новая система индикаторов
...
function onWindowResize() {
    ...
    // Старое позиционирование кругов удалено - используется новая система индикаторов
...
// Старые круги удалены - используется новая система индикаторов прибыли

// Функция для начального позиционирования кругов - удалена (используется новая система индикаторов)

// Старые круги для хранилища удалены - используется новая система индикаторов
// Обработчик клика удален - используется новая система с анимацией
...
setInterval(()=>{
    ...
    if(progress>=60){
        ...
        // Обновление старого круга удалено - используется новая система индикаторов
    }
},1000/60);

function updateProgressVisual(){
    // Старая функция обновления визуализации прогресса удалена - используется новая система индикаторов
}
...
function animate() {
    ...
    // Старое позиционирование кругов удалено - используется новая система индикаторов прибыли
...
// Старые круги для завода удалены - используется новая система индикаторов
...
function createFactory(){
    ...
    // Старое отображение кругов удалено - используется новая система индикаторов
    ...
    // Старое создание внутреннего круга удалено - используется новая система индикаторов
}
...
setInterval(()=>{
    ...
    if(factoryObj){
        ...
        // Старое обновление визуализации прогресса удалено - используется новая система индикаторов
    }
},1000/60);

// Старый обработчик клика удален - используется новая система индикаторов с анимацией
...
if(phonePanel){
    ...
    function toggleCircles(show){
        // Старая функция скрытия/показа кругов удалена - используется новая система индикаторов
        // Новая система автоматически скрывает индикаторы при открытии панелей
    }
...
function createStorage(){
    ...
    // Старое отображение круга хранилища удалено - используется новая система индикаторов
